...
**（2026-09-15 HANDOFF-004查證補充）**：這個單價是以「UTF-8 bytes」計費，**中文字元通常每字3 bytes、英文每字約1 byte**，代表《九曜》以中文為主的配音實際成本，會比直接套用英文範例的換算表貴上2~3倍。試算成本時務必直接用中文實際文本測試計費結果，不要只用官方英文範例外推。
...
- Creator：**常態價US$11/月**，US$22/月是首月促銷價（2026-09-15 HANDOFF-004查證修正，
  原草案寫法容易讓人誤讀成常態月費是$22，試算預算時請用$11/月為準）
- Pro：US$99/月
